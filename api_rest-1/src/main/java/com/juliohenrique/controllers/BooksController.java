package com.juliohenrique.controllers;
...
import com.juliohenrique.util.MediaType;
...
public class BooksController {
	...
	public ResponseEntity<PagedModel<EntityModel<BooksVO>>> findAll(
		...
		var sortDirection = "asc".equalsIgnoreCase(direction) ? Direction.DESC : Direction.ASC;
    ...
    @Operation(summary = "Adds new Book", 
		description = "Adds new Book by passing in a JSON, XML or YML representation of the Book!",
		tags = {"Book"},
		responses = {
			@ApiResponse(description = "Success", 
				responseCode= "200", 
	...
	public BooksVO create(
			@RequestBody BooksVO book){
    ...
    @Operation( summary = "Updated a Book", 
        description = "Updates a Person by passing in a JSON, XML or YML representation of the book!",
        tags = {"Book"},
        responses = {
    ...
    @Operation( summary = "Deletes a Books", 
		description = "Deletes a Person by passing in a JSON, XML or YML representation of the book!",
		tags = {"Book"},
		responses = {
