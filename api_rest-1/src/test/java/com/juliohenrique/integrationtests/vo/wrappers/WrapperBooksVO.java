...
public class WrapperBooksVO implements Serializable {
	...
	private BooksEmbeddedVO embedded;

	public WrapperBooksVO() {
	}

	public BooksEmbeddedVO getEmbedded() {
		return embedded;
	}

	public void setEmbbeded(BooksEmbeddedVO embedded) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
        WrapperBooksVO other = (WrapperBooksVO) obj;
		if (embedded == null) {
