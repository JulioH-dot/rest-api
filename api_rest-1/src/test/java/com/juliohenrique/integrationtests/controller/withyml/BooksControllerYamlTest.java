...
public class BooksControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        ...
        List<BooksVO> content = response.getContent();

        BooksVO foundBookOne = content.get(0);
        ...
        BooksVO foundBookFive = content.get(4);
