package com.juliohenrique.integrationtests.controller.withxml;
...
import com.juliohenrique.data.vo.v1.security.TokenVO;
...
import com.juliohenrique.integrationtests.vo.pagedmodels.PagedModelBooks;
...
public class BooksControllerXmlTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		PagedModelBooks wrapper = objectMapper.readValue(content, PagedModelBooks.class);
		List<BooksVO> books = wrapper.getContent();
