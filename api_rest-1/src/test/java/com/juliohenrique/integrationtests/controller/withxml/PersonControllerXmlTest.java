...
import com.juliohenrique.integrationtests.vo.pagedmodels.PagedModelPerson;
...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("3 Eagle Crest Court", foundPersonOne.getAdress());
		...
		assertEquals("57 Roxbury Pass", foundPersonSix.getAdress());
